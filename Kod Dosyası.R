...
yeniveriseti <- drop_na(mxmh_survey_results)
...
# Müzik türlerinin mental haslatıklara(Anksiyete,Depresyon,Uykusuzluk Hastalığı,
# Obsesif Kompulsif Bozukluk) etkisi çoklu çubuk grafiği ile görselleştirilmiştir. 
# Görselleştirilmeden önce değişkenler üzerinde çeşitli işlemler uygulanmıştır.
...
# Enstrüman çalmanın mental haslatıklara(Anksiyete,Depresyon,Uykusuzluk Hastalığı,
# Obsesif Kompulsif Bozukluk) etkisi kernel yoğunluk grafiği ile görselleştirilmiştir.
...
# Beste yapmanın mental haslatıklara(Anksiyete,Depresyon,Uykusuzluk Hastalığı,
# Obsesif Kompulsif Bozukluk) etkisi Donut Grafiği ile görselleştirilmiştir. 
# Görselleştirilmeden önce değişkenler üzerinde çeşitli işlemler uygulanmıştır.
...
# Günde dinlenilen müzik süresinin mental haslatıklara(Anksiyete,Depresyon,
# Uykusuzluk Hastalığı,Obsesif Kompulsif Bozukluk) etkisi Sacılım Grafigi 
# Dikdörtgen Gruplama ile görselleştirilmiştir.
...
ggplot(yeniveriseti, aes(Anxiety, `Hours per day`)) +
  ...
  labs(title = "Günde Dinlenilen Müzik Süresinin Anksiyeteye Etkisi",
       ...
       x= "Anksiyete Seviyeleri",
       y= "Günde Dinlenen Müzik Süresi(saat)",
       fill= "Kisi Sayısı")
...
ggplot(yeniveriseti, aes(Insomnia, `Hours per day`)) +
  ...
  labs(title = "Günde Dinlenilen Müzik Süresinin Uykusuzluk Hastaligina Etkisi",
       subtitle = "Sacılım Grafigi ile Dikdörtgen Gruplama",
       x= "Uykusuzluk Hastaligi Seviyeleri",
       y= "Günde Dinlenen Müzik Süresi(saat)",
       fill= "Kisi Sayısı")
...
ggplot(yeniveriseti, aes(OCD, `Hours per day`)) +
  ...
  labs(title = "Günde Dinlenilen Müzik Süresinin Obsesif Kompulsif Bozukluga Etkisi",
       subtitle = "Sacılım Grafigi ile Dikdörtgen Gruplama",
       x= "Obsesif Kompulsif Bozukluga Seviyeleri",
       y= "Günde Dinlenen Müzik Süresi(saat)",
       fill= "Kisi Sayısı")
